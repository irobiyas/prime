        ...
        <div class="row">
            ...
            if ($query) {
                while ($buku = mysqli_fetch_assoc($query)) {
                    ...
                    $buku_id = $buku['BukuID']; // Ambil ID buku
                    // Path gambar
                    $gambar_path = 'assets/img/' . htmlspecialchars($gambar);
            ?>
            <div class="col-md-3 mb-3">
                <div class="card">
                        <a href="index.php?page=detail_buku&id=<?php echo $buku['BukuID']; ?>">
                        <img src="<?php echo $gambar_path; ?>" alt="<?php echo htmlspecialchars($judul); ?>" style="max-width: 450px; width: 100%; height: auto;">
                        </a>
                    <div class="card-body">
